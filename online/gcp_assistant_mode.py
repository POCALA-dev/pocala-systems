...
from online.gcp_grammar import grammar_mode
from online.gcp_ask import ask_mode
from online.gcp_question import question_mode
from online.gcp_speaking import speaking_mode

ASSISTANT_KEYWORDS = {
    "grammar": ["grammar", "tata bahasa", "ram", "mar", "gra"],
    "ask": ["ask", "tanya", "asking", "tanya jawab", "as"],
    "question": ["exercise", "soal", "question"],
    "speaking": ["speaking", "speak", "speaking partner", "bicara"]
}
...
def gcp_assistant_mode(lcd=None):
    """
